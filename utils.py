...
def story_D(message):
    ...
    start = ("在一個多元社區裡，有一個年輕的女工程師名叫小雨。她充滿熱情和才華，致力於推動社區內的科技創新。\n"+
             ...
             "D1b:尋求男性同事的支持，希望他們能幫助她獲得評審的認同\n"+
             "D1c:決定放棄，覺得自己的努力無法改變現狀"
            )
    D1 = ("艾麗絲深吸一口氣，堅定地解釋了她的發明如何能夠改善環境，並詳細回答了評審的所有問題。\n"+
            "她的熱情和專業知識終於打動了評審，獲得了競賽的最高榮譽。\n"+
            "然而，她的成功並沒有結束性別偏見的挑戰。"
          )
    D1 = ("艾麗絲決定尋求男性同事的支持，希望他們能幫助她獲得評審的認同。\n"+
           "她的同事們被她的熱情感染，決定幫助她。他們一起努力，最終說服了評審，艾麗絲獲得了競賽的榮譽。\n"+
            "但這也讓艾麗絲開始思考，為什麼她需要依賴男性的支持才能獲得成功。"
          )
    
    D1 = ("艾麗絲感到沮喪和無力，決定放棄參賽。\n"+
